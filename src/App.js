...
class App extends Component {
    ...
    /**
     * The video list doesn’t have any state so we can make it a plain functional component. We need to pass the search
     * result from the parent, App, to the child, VideoList.  Define a property on the JSX tag:
     * <Videos/> videos={this.state.videos} />. Passing data like this is called passing ‘props’ in React. The we are
     * passing is being given to a ‘prop’. The ‘prop’ gets passed to VideoList. Every time the application re-renders
     * the ‘prop’ such as when we set state, VideoList will get the new list of videos.
     */
